 ...
 *                 int[:, ::1] pos0, int[:, ::1] pos1):
 */
  __pyx_tuple__20 = PyTuple_Pack(14, __pyx_n_s_image, __pyx_n_s_descriptors, __pyx_n_s_keypoints, __pyx_n_s_pos0, __pyx_n_s_pos1, __pyx_n_s_k, __pyx_n_s_d, __pyx_n_s_kr, __pyx_n_s_kc, __pyx_n_s_pr0, __pyx_n_s_pr1, __pyx_n_s_pc0, __pyx_n_s_pc1, __pyx_n_s_p); if (unlikely(!__pyx_tuple__20)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 9; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_tuple__20);
  __Pyx_GIVEREF(__pyx_tuple__20);
  __pyx_codeobj__21 = (PyObject*)__Pyx_PyCode_New(5, 0, 14, 0, 0, __pyx_empty_bytes, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_tuple__20, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_kp_s_home_stefan_src_scikit_image_sk, __pyx_n_s_brief_loop, 9, __pyx_empty_bytes); if (unlikely(!__pyx_codeobj__21)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 9; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
